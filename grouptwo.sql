...
CREATE TABLE MAJOR
( 
  MajID       int       NOT NULL AUTO_INCREMENT,
  MajName     char(50)  NOT NULL ,
  MajSchool  char(100)      NOT NULL ,
  DepID           int       NOT NULL ,
  PRIMARY KEY (MajID)
) ENGINE=INNODB;
...
ALTER TABLE DEPARTMENT ADD CONSTRAINT fk_DEPARTMENT_SCHOOL FOREIGN KEY (DepSchool) REFERENCES SCHOOL (SchlID);
...
ALTER TABLE SCHOOLADR ADD CONSTRAINT fk_SCHOOLADR_SCHOOL FOREIGN KEY (SchlID) REFERENCES SCHOOL (SchlID);
...
ALTER TABLE CONTPHONE ADD CONSTRAINT fk_CONTPHONE_EMERCONTACT FOREIGN KEY (ContID) REFERENCES EMERCONTACT (ContID);

ALTER TABLE EMERCONTACT ADD CONSTRAINT fk_EMERCONTACT_PERSON FOREIGN KEY (PerID) REFERENCES PERSON (PerID);

ALTER TABLE STUDENT ADD CONSTRAINT fk_STUDENT_PERSON FOREIGN KEY (PerID) REFERENCES PERSON (PerID);
ALTER TABLE STUDENT ADD CONSTRAINT fk_STUDENT_SCHOOL FOREIGN KEY (SchlID) REFERENCES SCHOOL (SchlID);

ALTER TABLE REGISTERS ADD CONSTRAINT fk_REGISTERS_CLASS FOREIGN KEY (ClassID) REFERENCES CLASS (ClassID);
ALTER TABLE REGISTERS ADD CONSTRAINT fk_REGISTERS_STUDENT FOREIGN KEY (StudentID) REFERENCES STUDENT (StudentID);

ALTER TABLE SUBSCRIBE ADD CONSTRAINT fk_SUBSCRIBE_STUDENT FOREIGN KEY (StudentID) REFERENCES STUDENT (StudentID);
ALTER TABLE SUBSCRIBE ADD CONSTRAINT fk_SUBSCRIBE_MAJOR FOREIGN KEY (MajID) REFERENCES MAJOR (MajID);

ALTER TABLE MAJOR ADD CONSTRAINT fk_MAJOR_DEPARTMENT FOREIGN KEY (DepID) REFERENCES DEPARTMENT (DepID);
